  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div class="flex items-center mx-2">
        ...
        <a href="<?php echo get_category_link(get_the_category()[0]->cat_ID);?>" class="ml-1 text-sm font-medium hover:text-color-base-alt"><?php echo get_the_category()[0]->cat_name;?></a>
      </div>
    </li>
    <li aria-current="page">
      <div class="flex items-center ">
        ...
        <span class="ml-1 text-sm font-medium"><?php the_title();?></span>
      </div>
    </li>
  </ol>
</nav>
