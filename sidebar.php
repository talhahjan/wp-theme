...
<aside>
          <div class="sticky top-14 pb-4 flex flex-col gap-6">
            ...
            >
              <div
                class="thumbnail w-28 h-28 relative after:absolute after:top-0 after:left-0 after:w-[calc(100%_+_10px)] after:h-[calc(100%_+_5px)] after:bg-primary after:shadow after:rounded-[33%_67%_50%_50%_/50%_14%_86%_50%] after:-z-50"
              >
                <img
                  src="<?php echo get_template_directory_uri()?>/assets/images/me.jpg"
                  class="w-full h-full rounded-[50%]"
                  alt=""
                />
              </div>
              <h2 class="text-lg md:text-base whitespace-nowrap">
                Muhammad Khalid
              </h2>

              <h3 class="font-semibold text-color-base-alt">Web Devloper</h3>
              <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="#">
                  <svg
                    class="w-10 h-10 md:w-4 md:h-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
